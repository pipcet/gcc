...
asm(".globl __wasm_null\n\t"
    ".text\n\t"
    "createsig FvE\n\t"
    ".pushsection .space.import_.null,\"ax\"\n\t"
    ".reloc .,R_WASM32_CODE_POINTER,0f\n\t"
    ".byte 0\n\t"
    ".popsection\n\t"
    ".pushsection .wasm.import_.null,\"ax\"\n\t"
    "0:      lstring \"sys\"\n\t"
    "lstring \"null\"\n\t"
    ".byte 0\n\t"
    "rleb128 __sigchar_FvE\n\t"
    ".popsection\n\t"
    ".pushsection .space.function_index.import_.null,\"ax\"\n\t"
    ...
    ".byte 0\n\t"
    ".popsection\n\t"
    ".pushsection .space.element.import_.null,\"ax\"\n\t"
    ".reloc .,R_WASM32_CODE_POINTER,0f\n\t"
    "1:      .byte 0\n\t"
    ".popsection\n\t"
    ".pushsection .wasm.element.import_.null,\"ax\"\n\t"
    "0:      rleb128_32 __wasm_null\n\t"
    ".popsection\n\t"
    ".if 0\n\t"
    ".pushsection .space.name.function.import_.null,\"ax\"\n\t"
    ".byte 0\n\t"
    ".popsection\n\t"
    ".pushsection .wasm.name.function.import_.null,\"ax\"\n\t"
    "lstring null\n\t"
    ".byte 0\n\t"
    ".popsection\n\t"
    ".endif\n\t");
